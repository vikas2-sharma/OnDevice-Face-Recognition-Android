...
import com.ml.shubham0204.facenet_android.presentation.screens.add_face.caputre.RegisterFaceScreenViewModel

private const val TAG = "FaceRegisterOverlay"

@SuppressLint("ViewConstructor")
@ExperimentalGetImage
class FaceRegisterOverlay(
    private val lifecycleOwner: LifecycleOwner,
    private val context: Context,
    private val viewModel: RegisterFaceScreenViewModel,
        ...
        ImageAnalysis.Analyzer { image ->
            ...
            CoroutineScope(Dispatchers.Default).launch {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    this@FaceRegisterOverlay.predictions = predictions.toTypedArray()
                    boundingBoxOverlay.invalidate()
                    isProcessing = false
                }
            }
